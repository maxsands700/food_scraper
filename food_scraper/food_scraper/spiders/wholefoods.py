...
class WholeFoodsSpider(scrapy.Spider):
    ...
    # Changed from single values to lists for future expansion
    store_ids = [10509]
    categories = ['produce']
    limit = 60
        ...
        try:
            ...
            if offset == 0:
                ...
                if total_products:
                    ...
                    # Add throttling for pagination requests
            ...
            for i, product in enumerate(products):
                ...
                if not self.build_id_available:
                    ...
                    yield self.make_product_detail_request(product.get('slug'), store_id, product_loader)
        except json.JSONDecodeError as e:
            self.logger.error(
    ...
    def make_product_detail_request(self, slug, store_id, product_loader):
        ...
        return scrapy.Request(
            ...
            meta={'product_loader': product_loader, 'sops_country': 'us'},
    ...
    def parse_product_details(self, response):
        ...
        try:
            ...
            product_loader.add_value(
                'detail_uri', product_detail_data.get('detailUri'))

            categories = product_detail_data.get('categories', {})
            product_loader.add_value('child_category', categories.get(
